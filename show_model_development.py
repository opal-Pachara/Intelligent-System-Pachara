...
=======
        ...
        st.markdown("""<p style='font-family: Athiti; text-align: justify;'>
                       <span style="font-weight: bold;">Feature Engineering </span> 
                    คือการสร้างข้อมูลใหม่จากข้อมูลดิบใน CSV เพื่อให้วิเคราะห์หรือนำเสนอได้ดีขึ้น 
                    โดยใช้ข้อมูลที่มี เช่น ปริมาณขยะ รีไซเคิล ประชากร และนโยบาย
    </p>""", unsafe_allow_html=True)
        st.markdown("""<p style='font-family: Athiti; text-align: justify;'>
...
<<<<<<< HEAD
                    โค้ดนี้พัฒนาโมเดล 
                    <span style="background-color: #990000;">SVR (Support Vector Regression)</span>SVR (Support Vector Regression) 
=======
<<<<<<< HEAD
                    โค้ดนี้พัฒนาโมเดล 
                    <span style="background-color: #990000;">SVR (Support Vector Regression)</span>SVR (Support Vector Regression) 
